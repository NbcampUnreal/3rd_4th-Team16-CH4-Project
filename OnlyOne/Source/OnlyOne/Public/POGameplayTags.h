...
namespace POGameplayTags
{
	...
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_SmokeGrenade);
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Interaction);
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_ListWidget);
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_ListWidget_Show);
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_ListWidget_Hide);
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_EscapeMenu);
	...
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_SmokeGrenade);
   ...
   /* GameplayCue Tags*/
	...
	ONLYONE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Smoke);
